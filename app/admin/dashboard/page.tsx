        ...
        <div className="space-y-8 p-6 md:p-8 pt-6">
            ...
            <div className="grid gap-4 md:grid-cols-3">
                <Card className="border-green-100 bg-green-50/50 dark:bg-green-900/10 dark:border-green-900">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium text-green-700 dark:text-green-400">Successful Orders</CardTitle>
                        <CheckCircle className="h-4 w-4 text-green-600 dark:text-green-400" />
                    </CardHeader>
                    <CardContent>
                        <div className="text-2xl font-bold text-green-700 dark:text-green-300">{stats.successfulOrders}</div>
                        <p className="text-xs text-green-600/80 dark:text-green-400/80">Completed purchases</p>
                    </CardContent>
                </Card>
                ...
                <Card className="border-amber-100 bg-amber-50/50 dark:bg-amber-900/10 dark:border-amber-900">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-amber-600/80 dark:text-amber-400/80">With email captured</p>
                    </CardContent>
                </Card>
            </div>
